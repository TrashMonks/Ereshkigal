module.exports = {
    ...
    description:
`Given the ID of a message in the same channel as the command that was originally posted by the bot, the bot replaces its contents with the specified text and then deletes the message that triggered the command.
